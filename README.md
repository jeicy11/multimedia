...
Cada flujo se representa mediante 4 tablas:
...
La tabla **usuarios** es compartida por ambos flujos.
...
| Flujo | Proceso | Siguiente | Tipo | Rol | Pantalla |
|--------|----------|------------|------|------|-----------|
...
## Tabla flujoCondicion

| Flujo | Proceso | Proceso SI | Proceso NO |
|--------|----------|------------|------------|
| F1 | P4 | P5 | P1 |
...
| Ticket | Proceso | Usuario | Inicio | Fin |
|----------|----------|----------|---------|------|
